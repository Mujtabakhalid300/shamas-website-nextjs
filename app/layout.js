        ...
        {!showFirstHeader && (
          <div
            className={`absolute left-0 w-full bg-originalBlue text-white transition-all duration-300 ease-in-out ${
              menuOpen ? "top-14 opacity-100 py-4" : "top-14 opacity-0 max-h-0 overflow-hidden"
            }`}
          >
            <ul className="flex flex-col items-start gap-4">
            <Link href="/" className="pl-4 w-full focus:bg-[#193658] transition-all duration-300">OVERVIEW</Link>
              <Link href="/portfolio" className="pl-4 w-full focus:bg-[#193658] transition-all duration-300">PORTFOLIO</Link>
              <Link href="/availability" className="pl-4 w-full focus:bg-[#193658] transition-all duration-300">AVAILABILITY</Link>
              <Link href="/management" className="pl-4 w-full focus:bg-[#193658] transition-all duration-300">MANAGEMENT</Link>
              <Link href="/contact" className="pl-4 w-full focus:bg-[#193658] transition-all duration-300">CONTACT</Link>
            </ul>
          </div>
        )}
